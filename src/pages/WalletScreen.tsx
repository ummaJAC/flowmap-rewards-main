...
const WalletScreen = () => {
  ...
  // Fetch private key on-demand (never stored in global state)
  const handleRevealKey = async () => {
    if (privateKey) { setShowPrivateKey(!showPrivateKey); return; }
    try {
    ...
    } catch { setPrivateKey('Failed to load'); }
  };
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col gap-1 mb-4 p-2 bg-slate-50 border border-red-100 rounded-xl relative">
                <div className="flex justify-between items-center">
                    ...
                    <button onClick={handleRevealKey} className="text-[10px] text-slate-400 underline">
